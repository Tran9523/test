...
main(int argc, char *argv[])
{
    ...
    char buf[SIZE];
    char str[] =
    "There are a variety pf substances in the water which \
...
/*
peter@peter:~/test/linux-study/skill_book/chap3_3$ gcc 301.c
...
Text copied to 301_copy.txt

peter@peter:~/test/linux-study/skill_book/chap3_3$ ./a.out

This program shows file write and copy.

open() failed. File will be deleted: File exists
Existing file is flushed.
