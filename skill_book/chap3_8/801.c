...
/*
peter@peter:~/test/linux-study/skill_book/chap3_8$ gcc 801.c
peter@peter:~/test/linux-study/skill_book/chap3_8$ ./a.out -f /tmp/socktest
[Parent]: Message to child: Hi socket server
[Child1]: [17 bytes]: Hi socket server
[Parent]: Message to child: i'm client
[Child1]: [11 bytes]: i'm client
[Parent]: Message to child: what?
[Child1]: [6 bytes]: what?
