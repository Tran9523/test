...
static void array_free(int **array);        // 추가
...
/*
peter@peter:~/test/linux-study/skill_book/chap3_9$ gcc 901_multi_thread.c -o mthread -lpthread
peter@peter:~/test/linux-study/skill_book/chap3_9$ ./mthread -n 2
Sum of result array: 25769803776.00
peter@peter:~/test/linux-study/skill_book/chap3_9$ time ./mthread -n 4
Sum of result array: 25769803776.00

real    0m51.873s
user    1m41.887s
sys     0m0.576s
peter@peter:~/test/linux-study/skill_book/chap3_9$ time ./mthread -n 8
Sum of result array: 25769803776.00

real    0m55.059s
user    1m47.829s
sys     0m0.690s
// B의 구조상 multi 로 들어가도 계산속도가 느릴거다가 gpt 조언
// 추가 확인 결과 VM 가상환경이라 1~2 스레드만 받을 수 있음
*/