    ...
    switch (argv[1][1]) {
        case 's':
            ...
            if (pid == -1) {
                ...
                printf("[Parnet]: Send message to child process.\n");
...
/*
peter@peter:~/test/linux-study/skill_book/chap3_6$ gcc 603.c
peter@peter:~/test/linux-study/skill_book/chap3_6$ ./a.out -s
[Parnet]: Send message to child process.
[Child]: This message is from parent process.
peter@peter:~/test/linux-study/skill_book/chap3_6$ ./a.out -m
[Parent]: PUT: Hey child, Cheer up!
[Child]: GET: Hey child, Cheer up!
[Child]: PUT: Okay, See you later
[Parent]: GET: Okay, See you later
*/