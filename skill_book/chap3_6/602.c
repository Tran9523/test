...
/*
peter@peter:~/test/linux-study/skill_book/chap3_6$ gcc 602.c
peter@peter:~/test/linux-study/skill_book/chap3_6$ ./a.out
[Child]: Process will lock [text.txt]
[Child]: File locked.
[Child]: File write complete.
[Parent]: Get lock information from [text.txt]
[Parent]: Locked by PID[25837]
[Parnet]: Lock type [1]
*/