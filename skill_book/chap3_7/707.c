...
/*
peter@peter:~/test/linux-study/skill_book/chap3_7$ gcc 707.c -lrt
peter@peter:~/test/linux-study/skill_book/chap3_7$ ./a.out -f /newshm
[Parent]: Wait for child...
[Child1]: GET: Hello child process
[Child1]: Exit program.
[Parent]: Done. Exit.
*/