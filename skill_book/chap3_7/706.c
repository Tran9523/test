...
main(int argc, char *argv[])
{
    ...
    if ((shmid = shmget((key_t)shmkey, MAX_SIZE,
            IPC_CREAT | IPC_EXCL | 0644)) == -1) {
                printf("[Parent]: Your key is conflicated. ");
...
/*
peter@peter:~/test/linux-study/skill_book/chap3_7$ gcc 706.c
peter@peter:~/test/linux-study/skill_book/chap3_7$ ./a.out -k 5150
[Child1]: I'm echo server.
[Parent]: Message to child: Hello child?
[Child1]: GET: Hello child?

[Parent]: Message to child: info
Print shared memory information.
   Permission:         644
   Size of segment:    256
   Last shmat():       Tue Jan  6 15:17:59 2026
   Last shmdt():       Thu Jan  1 09:00:00 1970
   Last change:        Tue Jan  6 15:17:59 2026
   PID of creator:     21554
   PID of last at/dt:  21555
   Current at process: 2

[Child1]: GET: info

[Parent]: Message to child: bye bye
[Child1]: GET: bye bye

[Parent]: Message to child: quit
