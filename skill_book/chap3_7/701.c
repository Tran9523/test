...
main(int argc, char *argv[])
{
    ...
    IPC_CREAT | IPC_EXCL | 0644)) == -1) {
        ...
        printf("Process wll re-define key as [%d]\n", mkey+1);
        mkey += 1;
...
/*
peter@peter:~/test/linux-study/skill_book/chap3_7$ gcc 701.c
peter@peter:~/test/linux-study/skill_book/chap3_7$ ./a.out -k 5522
[Child1]: GET: Hello
[Child1]: Now, I'm echo server.
[Child1]: GET: I'm ready
Hello
^C -> 그래서 gpt 수정 진행
*/